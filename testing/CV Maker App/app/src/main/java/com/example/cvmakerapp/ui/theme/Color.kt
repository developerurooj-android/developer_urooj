...
// Generated from DESIGN.md — "Executive Blueprint" design system
...
val SecondaryContainer = Color(0xFFD5E3FD)
val OnSecondaryContainer = Color(0xFF57657B)

val Tertiary = Color(0xFF000000)
val OnTertiary = Color(0xFFFFFFFF)
val TertiaryContainer = Color(0xFF00201E)
val OnTertiaryContainer = Color(0xFF00938E) // Muted Teal — success / active states
...
val SecondaryFixed = Color(0xFFD5E3FD)
val SecondaryFixedDim = Color(0xFFB9C7E0)
val OnSecondaryFixed = Color(0xFF0D1C2F)
val OnSecondaryFixedVariant = Color(0xFF3A485C)

val TertiaryFixed = Color(0xFF84F5EE)
val TertiaryFixedDim = Color(0xFF66D8D2)
val OnTertiaryFixed = Color(0xFF00201E)
val OnTertiaryFixedVariant = Color(0xFF00504D)
...
val CardShadowColor = Color(0x140F172A) // rgba(15,23,42,0.08)
